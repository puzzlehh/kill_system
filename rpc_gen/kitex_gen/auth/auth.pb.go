...
type DeliverTokenReq struct {
	...
	UserId int32 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // 默认值为0，不能手动指定
}
...
type VerifyTokenReq struct {
	...
	Token string `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"` // 默认值为空字符串，不能手动指定
}
...
type DeliveryResp struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // 默认值为空字符串，不能手动指定
}
...
type VerifyResp struct {
	...
	Res bool `protobuf:"varint,1,opt,name=res,proto3" json:"res,omitempty"` // 默认值为false，不能手动指定
}
...
var file_auth_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x75, 0x7a, 0x7a, 0x6c,
	0x65, 0x68, 0x68, 0x2f, 0x6b, 0x69, 0x6c, 0x6c, 0x5f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2f,
